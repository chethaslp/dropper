...
* Set the following environment variables:
    ...
    CRED_FILE : your firebase cred file URL. Do not set if its in the root folder. Upload it as a secret file in your PaaS.
...
STORAGE_URL = {'storageBucket': os.environ.get("STRG_BKT") or 'examerapp.appspot.com',
                'databaseURL': os.environ.get("STRG_DB") or 'https://examerapp.firebaseio.com'}
PASSWORD = os.environ.get("PASSWORD") or "chethas123"
VIEW_URL = os.environ.get("VIEW_URL") or "/view/clp"
